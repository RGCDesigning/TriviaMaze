...
public class mazeTrivia {
    ...
    public static void main(String[] args) {
            ...
            String question1 = "Who was the ancient Greek goddess of love and beauty?\n" + "(a) Aphrodite\n(b) Calliope\n(c) Athena\n(d) Calypso\n";            
        ...
        test[] questions  = {
                new test(question1, "a"),
                new test(question2, "a"),
                new test(question3, "b"),
                new test(question4, "b"),
                new test(question5, "d")
        };
